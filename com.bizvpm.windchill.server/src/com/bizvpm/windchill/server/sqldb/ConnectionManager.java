		...
		while (propNames.hasMoreElements()) {
			...
			if (name.endsWith(".url")) {
				...
				try {
					...
					System.out.println("ERROR SETTING OF: MAX CONNECTION COUNT"
							+ maxconn + " .POOL NAME: " + poolName);
					max = 10;
				}
				...
				System.out
						.println("CONNECTION POOL:" + poolName + " INIT...OK");
			}
		}
	}
