...
public class SQLRow {
	...
	public Object getValue(int colNo) throws Exception {
		if(data != null && colNo >= 0 && colNo < data.length){
			return data[colNo];
		}else{
			throw new Exception("Given Column Number Exceed Data Coumn Count");
		}
//		return data[colNo];
	}

	public String getText(int colNo) throws Exception {
		Object value = getValue(colNo);
		return Util.getString(value);
	}

	public String getText(String columnName) throws Exception {
	...
	public int find(String text, int style) throws Exception {
