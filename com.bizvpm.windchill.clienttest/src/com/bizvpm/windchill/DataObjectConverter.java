...
public class DataObjectConverter {
	...
	protected byte[] getBytes(File file) throws java.lang.Exception {
	...
	protected byte[] getBytes(InputStream is, long length) throws java.lang.Exception {
		/*
		...
		if (offset < bytes.length) {
			is.close();
			throw new java.lang.Exception("Could not completely read file ");
		}
